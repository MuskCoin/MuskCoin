...
uint256 hashGenesisBlock("0xe3ca0fd882bdaefe192121105f89657244210fbf7623a845aa0ff0865cb8de8e");
...
static const int64 nTargetTimespan = 10 * 60; // Learncoin: 10 minutes
static const int64 nTargetSpacing = 1 * 60; // Learncoin: 1 minute
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe3ca0fd882bdaefe192121105f89657244210fbf7623a845aa0ff0865cb8de8e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Elon Musk is God";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x580add24fef7b14f6f4c38a283b7fe98487b6d2827c194e448246de583d2265c"));
